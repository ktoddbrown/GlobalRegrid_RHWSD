...
Batjes 2016 estimated total soil carbon stocks at 1408 +- 154 Pg-C (mean + sd from n=400 bootstrap), which suggests use of `BULK.DENSITY` without a course fraction correction, counter to the guidance given in the HWSD documentation.
